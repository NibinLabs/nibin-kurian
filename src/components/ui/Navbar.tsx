...
import { ThemeProvider as NextThemesProvider, useArchitect } from './ThemeProvider';
...
export default function Navbar() {
    ...
    const toggleArchitect = () => setIsArchitectMode(!isArchitectMode);

    const handleNavClick = () => setMenuOpen(false);

    const toggleThemeLabel = resolvedTheme === 'dark' ? 'Switch to light mode' : 'Switch to dark mode';
    const toggleArchitectLabel = isArchitectMode ? 'Exit Architect Mode' : 'Visual Architect Mode';
            ...
            <nav className={`${styles.navbar} ${scrolled ? styles.scrolled : ''}`} role="navigation" aria-label="Main navigation">
                <div className={styles.inner}>
                    ...
                    <div className={styles.actions}>
                        <button
                            className={`${styles.themeToggle} ${styles.architectToggle} ${isArchitectMode ? styles.architectActive : ''}`}
                            onClick={toggleArchitect}
                            aria-label={toggleArchitectLabel}
                            data-tooltip={toggleArchitectLabel}
                        >
                            <ProjectIcon />
                        </button>
                        ...
                        <button
                            ...
                            data-tooltip={mounted ? toggleThemeLabel : 'Theme'}
                        >
